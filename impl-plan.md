...
| Plan status | Stage 5 approved; IP-001 through IP-004 complete, IP-005 authorized |
...
| NFR-001 | IP-001 baseline; IP-002 controller/tests | No-name statuses, content, ordering, and existing filter validation passed (AC-007) | Implemented; Stage 5 evidence passed |
...
| NFR-003 | IP-002 controller/tests | Every successful search asserted exact top-level members, count consistency, and unchanged todo fields (AC-004) | Implemented; Stage 5 evidence passed |
...
| --- | --- | --- | --- |
| IP-005 | Production dependency audit has not run. | Run the exact approved audit command after IP-004 completes and record its result without creating `verification.md`. | No dependency changes are authorized. |
| IP-006 | Stage 7 verification has not been authorized and IP-005 is incomplete. | Complete Stage 5/review prerequisites and explicitly enter Stage 7. | Required by SDLC stage boundary. |
